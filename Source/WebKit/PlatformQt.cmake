...
if (QT_STATIC_BUILD)
    ...
    if (MSVC)
        foreach (LIB_FILENAME ${LIBXML2_LIBRARIES})
            get_filename_component(LIB_NAME ${LIB_FILENAME} NAME_WE)
		    list(APPEND EXTRA_LIBS_NAMES ${LIB_NAME})
        endforeach ()
        foreach (LIB_FILENAME ${SQLITE_LIBRARIES})
            get_filename_component(LIB_NAME ${LIB_FILENAME} NAME_WE)
		    list(APPEND EXTRA_LIBS_NAMES ${LIB_NAME})
        endforeach ()
        list(APPEND EXTRA_LIBS_NAMES zlib)
    else ()
