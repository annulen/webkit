...
public:
    ...
    virtual bool supportsFocusRing(const RenderStyle&) const override { return true; }
...
protected:
    ...
    virtual void computeSizeBasedOnStyle(RenderStyle&) const override;
    virtual QSharedPointer<StylePainter> getStylePainter(const PaintInfo&) override;

    virtual QPalette colorPalette() const override;
